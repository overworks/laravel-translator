 ...
 * the endpoint directly through openai-php/client (no Prism dependency).
 *
 * This is for endpoints that Prism does not ship as a first-class provider —
 * self-hosted gateways, proxies, or vendors that expose the OpenAI schema. Point
 * it at a base URI and an API key in config and it behaves like the LLM drivers.
 *
